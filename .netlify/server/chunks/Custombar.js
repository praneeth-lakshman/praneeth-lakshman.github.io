import { c as create_ssr_component, d as compute_rest_props, a as setContext, f as spread, i as escape_object, h as escape_attribute_value, j as add_attribute, g as getContext, e as escape, l as get_current_component, v as validate_component, k as compute_slots, m as missing_component } from "./ssr.js";
...
const Custombar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { listOfItems = ["Home", "Science", "Philosophy", "Art", "Politics", "About"] } = $$props;
  let { isActive = "Home" } = $$props;
  ...
  const truthValues = listOfItems.map(function(x, i) {
    return { name: x, active: !!zeroValues[i] };
  });
  console.log(truthValues);
  if ($$props.listOfItems === void 0 && $$bindings.listOfItems && listOfItems !== void 0)
    $$bindings.listOfItems(listOfItems);
  if ($$props.isActive === void 0 && $$bindings.isActive && isActive !== void 0)
    $$bindings.isActive(isActive);
  return `<div class="relative px-8">${validate_component(Navbar, "Navbar").$$render(
    $$result,
    {
    ...
    {},
    {
      default: ({ hidden, toggle }) => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
          default: () => {
            return `<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white underline underline-offset-8" data-svelte-h="svelte-1xpj0mv">Conversations at Twilight</span>`;
          }
        })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, {}, {}, {})} ${validate_component(NavUl, "NavUl").$$render($$result, { hidden }, {}, {
          default: () => {
            return `${validate_component(NavLi, "NavLi").$$render($$result, { href: base + "/", active: true }, {}, {
              default: () => {
                return `Home`;
              }
            ...
            )} ${validate_component(NavLi, "NavLi").$$render($$result, { id: "art", href: base + "/Art" }, {}, {
              default: () => {
                return `Art`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { id: "pol", href: base + "/Politics" }, {}, {
              default: () => {
                return `Politics`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { id: "abt", href: base + "/About" }, {}, {
              default: () => {
                return `About`;
              }
