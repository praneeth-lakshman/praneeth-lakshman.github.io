...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Custombar, "Custombar").$$render($$result, { isActive: "Philosophy" }, {}, {})} <div class="text-center animate-in slide-in-from-bottom duration-1000">${validate_component(Heading, "Heading").$$render(
    $$result,
    {
      align: "center",
